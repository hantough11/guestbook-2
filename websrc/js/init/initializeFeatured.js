...
var makeFeaturedPlayer = new MakeFeatured();

$(document).ready(function () {
    set_featured();
    init_initializeFeatured();
});
...
function init_initializeFeatured() {
	...
	makeFeaturedEditor.cellWidth = 224;
	makeFeaturedEditor.cellHeight = 126;


    // Featured Player 생성
	makeFeaturedPlayer.kind = "player";
	makeFeaturedPlayer.wrapper = "#body_featured .player_scene";
	makeFeaturedPlayer.cellWidth = 256;
	makeFeaturedPlayer.cellHeight = 144;


	for (i = 1; i <= 9; i++) {
	    makeFeaturedList.build(i);
	    makeFeaturedPopup.build(i);
	    makeFeaturedEditor.build(i);
	    makeFeaturedPlayer.build(i);
	}
	...
	this.build = function (value) {
	    ...
	    //}
			...
			function setCover(wrapper) {
			    $(wrapper + "_" + featuredNo + "_img .cell_" + cellNo + " .cover").css({
			        "position": "absolute",
			    ...
			    $(wrapper + "_" + featuredNo + "_img .cell_" + cellNo + " .cover").hover(
                    function () {
		...
		function fillWidgetCellElement(width, height, wrapper) {
		    ...
		    $(wrapper + "_" + featuredNo + "_img .cell_" + cellNo + " .img_1").css({
		        "background-image": "url(" + featured[featuredNo].cell[cellNo].widget.image_url + ")",
		        "background-size": "100% 100%",
		    ...
		    if (featured[featuredNo].cell[cellNo].widget.widget_kind == "tv" || featured[featuredNo].cell[cellNo].widget.widget_kind == "video")
		        htmlString = "<div class='yt_" + featuredNo + "'><div id='ftplayer_" + featuredNo + "' style='width:100%;height:100%;'></div></div>";
		    else if (featured[featuredNo].cell[cellNo].widget.widget_kind == "weather")
		        htmlString = "<div class='weather_" + featuredNo + "'><div class='weather_data'></div></div>";

		    $("#body_featured .player_scene_" + featuredNo + "_img .cell_" + cellNo + " .img_1").html(htmlString);
		}
					...
					cellHTMLString =  "<a id='" + tempId + "' class='slideList' href='#'>" +
											"<div class='body_contents_sub list_" + tempId + "'>" +												
												"<div class='body_contents_" + tempId + "_img'>" +
													...
													"</div>" +		
												"</div>" +
												"<span class='divided'>" + featured[tempId].project_name + "</span>" +
												//"<span class='body_contents_1_text'><img src='../websrc/img/main/lb_main_featured_06.png'></span>" +
												"<span class='body_contents_1_widget_1'><img src='../websrc/img/main/lb_main_featured_07.png'></span>" +
												"<span class='body_contents_1_widget_2'><img src='../websrc/img/main/lb_main_featured_08.png'></span>" +
												"<span class='body_contents_1_widget_3'><img src='../websrc/img/main/lb_main_featured_09.png'></span>" +
												"<span class='body_contents_1_widget_4'><img src='../websrc/img/main/lb_main_featured_10.png'></span>" +
                                                "<span class='body_contents_1_widget_5'><img src='../websrc/img/main/lb_main_featured_11.png'></span>" +
                                                "<span class='body_contents_1_widget_6'><img src='../websrc/img/main/lb_main_featured_12.png'></span>" +
                                                "<span class='body_contents_1_widget_7'><img src='../websrc/img/main/lb_main_featured_13.png'></span>" +
											"</div>" +
										"</a>";
					break;
				case 'popup' :
